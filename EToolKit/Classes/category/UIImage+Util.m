...
{
    //    CGFloat originlW = image.size.width;
    CGFloat originlW = 72;
    CGFloat WH = originlW + 2 * border;
    CGSize newSize = CGSizeMake(WH, WH);
    ...
    CGRect bigRect = {{0,0},newSize};
    
    CGContextFillEllipseInRect(ctx, bigRect);
    
    CGRect smallRect = {{border,border},image.size};
